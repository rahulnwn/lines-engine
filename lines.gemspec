...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'orm_adapter', '~> 0.5.0'
  ...
  s.add_runtime_dependency 'acts-as-taggable-on', '~> 6.0.0'
  s.add_runtime_dependency 'bcrypt', '~> 3.1.0'
  s.add_runtime_dependency 'sitemap_generator', '~> 6.0.0'
  s.add_runtime_dependency 'jquery-fileupload-rails', '~> 0.4.6'
  s.add_runtime_dependency 'jquery-ui-rails', '>= 5.0.0'
  s.add_runtime_dependency 'sanitize', '~> 4.6.5'
  s.add_runtime_dependency 'sass-rails', '>= 4.0.0'
  s.add_runtime_dependency 'coffee-rails', '~> 4.2.0'
  ...
  s.add_runtime_dependency 'meta-tags', '~> 2.10.0'
